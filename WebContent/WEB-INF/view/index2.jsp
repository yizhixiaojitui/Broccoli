...
<!-- iButtons start -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/layout/plugins/ibuttons/css/jquery.ibutton.css"
	type="text/css" />
<script type="text/javascript"
	src="${pageContext.request.contextPath }/layout/plugins/ibuttons/lib/jquery.ibutton.min.js"></script>
<!-- iButtons end -->
