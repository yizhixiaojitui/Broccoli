    ...
    $('#clear').click(function (event) {
        ...
        $('#tailoringImg').cropper('destroy').cropper({'preview': '.previewImg'});
    });
    //裁剪后的处理
    ...
    $(document).ready(function(){
    	$(".replaceicon-border").mouseover(function(){
    		$(".replaceicon-msg").show();
    	})
    	$(".replaceicon-msg").mouseout(function(){
    		$(".replaceicon-msg").hide();
    		});
    })